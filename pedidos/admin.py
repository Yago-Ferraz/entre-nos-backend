...
class ItemPedidoAdmin(admin.ModelAdmin):
    list_display = ("id", "pedido", "produto", "quantidade", "preco_unitario", "subtotal", "created_at", "created_by", "updated_at", "updated_by")
    search_fields = ("pedido__id", "produto__nome")
    list_filter = ("produto", "created_at", "created_by", "updated_by")
    readonly_fields = ("created_at", "updated_at", "created_by", "updated_by")

    fieldsets = (
        (None, {
            'fields': ("pedido", "produto", "quantidade", "preco_unitario")
        }),
        ('Auditoria', {
            'fields': ("created_at", "created_by", "updated_at", "updated_by")
        })
